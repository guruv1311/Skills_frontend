...
export async function GET(req: NextRequest) {
    try {
        ...
        const backendUrl = `${API_URL}/api/team/manager/${managerId}/certifications-summary`;
        console.log(`Fetching certifications summary from: ${backendUrl}`);
        ...
        if (!backendRes.ok) {
            console.warn(`Backend certifications fetch failed: ${backendRes.status}`);
        ...
        console.error("Manager certifications error:", err);
